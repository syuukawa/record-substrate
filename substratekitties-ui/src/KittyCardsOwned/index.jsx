...
class KittyWrap extends ReactiveComponent {
    ...
    readyRender() {
        ...
        return <KittyCard
            kitty={runtime.substratekitties.kitties(this.state.hash)} //Kitty
            // owner={this.state.owner} //Kitty owner
        />
    }
}
//001-
export class KittyCardsOwned extends ReactiveComponent {
    constructor(props) {
        super(['owner', 'count'])
    ...
    readyRender() {
        ...
        //             <KittyWrap hash={runtime.substratekitties.allKittiesArray(owner,i)} />
        //         </div>
        //     );
        // }
